...
&nbsp;
![Followers](https://img.shields.io/github/followers/nafiurrahmanniloy?style=flat-square&color=8B5CF6&label=Followers)
...
Production chatbot deployed for a real client — LangChain + n8n + OpenAI with live conversation memory
<br/><br/>
`LangChain` `n8n` `OpenAI` `JavaScript`
...
### 🌍 [Multilingual RAG System](https://github.com/nafiurrahmanniloy/multilingual-rag-system)
Cross-language RAG with Pinecone vector search, HuggingFace embeddings & Gemini — production grade
<br/><br/>
`LangChain` `Pinecone` `HuggingFace` `Gemini` `n8n`
